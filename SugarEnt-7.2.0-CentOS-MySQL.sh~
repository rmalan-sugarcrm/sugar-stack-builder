...
# =======================================================================
# 
# SugarEnt-7.x-centos-mysql.sh
#
# Script to automate installing a LAMP stack for Sugar Enterprise 7.x
# on CentOS 6.5.
#
...
#
# This has been tested with Sugar Enterprise 7.2.0 and 7.5.0.0 versions
# of the full software (not the upgrade version).
#
...
#
#   2, SUGAR_FULL_BASE
#      Specifies the top level directory name to look for in the unzipped
#      contents of SUGAR_ZIP_BASE.
#
#   3. SUGAR_HTML_TARGET
...
SUGAR_ZIP_BASE="SugarEnt-7.5.0.0"
SUGAR_FULL_BASE="SugarEnt-Full-7.5.0.0"
#SUGAR_ZIP_BASE=""
#SUGSAR_FULL_BASE=""
...
ZIPLOG="$LOGDIR/install.$TIMESTAMP.zip.out.log"
...
then
  ...
  then
    ...
    rm -rf /var/www/html/$SUGAR_FULL_BASE
    unzip zip/$SUGAR_ZIP_BASE.zip -d /var/www/html >> $ZIPLOG 2>&1
    echo "Creating /var/www/html/$SUGAR_HTML_TARGET directory..."
    echo "Creating /var/www/html/$SUGAR_HTML_TARGET directory..." >> $LOG
    mv /var/www/html/$SUGAR_FULL_BASE /var/www/html/$SUGAR_HTML_TARGET
